...
class Tester():
    ...
    def __init__(self, model_path, model_name, epoch, test_params, use_cuda, net_type="LeNet",):
        ...
        self.epoch = epoch
        self.r_path = model_path + model_name + "_" + str(epoch)+'.pth'
        self.R.load_state_dict(torch.load(self.r_path))
